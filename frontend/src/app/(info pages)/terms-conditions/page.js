...
export default function Page() {
  return (
    <div>
      <p>
        This website is operated by Berce. Throughout the site, the terms “we”,
        “us” and “our” refer to Berce. Berce offers this website, including all
        ...
        new features or tools that are added to the current store shall also be
        ...
        acceptance of those changes. Our store is hosted on Shopify. They
        provide us with an online e-commerce platform that allows us to sell our
        products and Services to you. SECTION 1 - ONLINE STORE TERMS By agreeing
        to these Terms of Service, you represent that you are at least the age
        ...
        these Terms. SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF
        INFORMATION We are not responsible if the information made available on
        this site is not accurate, complete, or current. The material on this
        site is provided for general information only and should not be relied
        upon or used as the sole basis for making decisions without consulting
        ...
        site. SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES Prices for our
        ...
        discontinuance of the Service. SECTION 5 - PRODUCTS OR SERVICES Certain
        ...
        https://berce.co/pages/returns-exchange-policy We have made every effort
        ...
        and/or shipping address. In the event that we make a change to or cancel
        an order, we may attempt to notify you by contacting the e‑mail and/or
        billing address/phone number provided at the time the order was made. We
        reserve the right to limit or prohibit orders that, in our sole
        judgment, appear to be placed by dealers, resellers or distributors. You
        ...
        your transactions and contact you as needed. For more details, please
        review our Refund Policy: https://berce.co/pages/returns-exchange-policy
        ...
        tools. Any use by you of the optional tools offered through the site is
        ...
        shall also be subject to these Terms of Service. SECTION 8 - THIRD-PARTY
        ...
        sole discretion to be unlawful, offensive, threatening, libellous,
        ...
        posted by you or any third-party. SECTION 10 - PERSONAL INFORMATION Your
        submission of personal information through the store is governed by our
        Privacy Policy, which can be viewed here:
        https://berce.co/pages/privacy-policy SECTION 11 - ERRORS, INACCURACIES
        ...
        durability, title, and non-infringement. In no case shall Berce, our
        ...
        INDEMNIFICATION You agree to indemnify, defend and hold harmless Berce
        ...
        rights of a third-party. SECTION 15 - SEVERABILITY In the event that any
        ...
        survive the termination of this agreement for all purposes. These Terms
        of Service are effective unless and until terminated by either you or
        us. You may terminate these Terms of Service at any time by notifying us
        that you no longer wish to use our Services, or when you cease using our
        site. If in our sole judgment you fail, or we suspect that you have
        ...
        any part thereof). SECTION 17 - ENTIRE AGREEMENT The failure of us to
        ...
        construed against the drafting party. SECTION 18 - GOVERNING LAW These
        ...
        of India. SECTION 19 - CHANGES TO TERMS OF SERVICE You can review the
